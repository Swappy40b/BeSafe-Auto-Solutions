<%@ Page Title="" Language="C#" MasterPageFile="~/Mechanics.master" AutoEventWireup="true" CodeFile="viewusersfeedback.aspx.cs" Inherits="viewusersfeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [feedbackuser] WHERE ([mname] = @mname)">
        <SelectParameters>
